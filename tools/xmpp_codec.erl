...
decode({xmlel, _name, _attrs, _} = _el, Opts) ->
    ...
    case {_name, get_attr(<<"xmlns">>, _attrs)} of
      ...
      {<<"standby">>, <<"p1:rebind">>} ->
	  decode_p1_standby(<<"p1:rebind">>, IgnoreEls, _el);
      {<<"rebind">>, <<"p1:rebind">>} ->
	  decode_p1_rebind(<<"p1:rebind">>, IgnoreEls, _el);
      {<<"sid">>, <<"p1:rebind">>} ->
	  decode_p1_rebind_sid(<<"p1:rebind">>, IgnoreEls, _el);
      {<<"jid">>, <<"p1:rebind">>} ->
	  decode_p1_rebind_jid(<<"p1:rebind">>, IgnoreEls, _el);
      {<<"failure">>, <<"p1:rebind">>} ->
	  decode_p1_rebind_failure(<<"p1:rebind">>, IgnoreEls,
				   _el);
      {<<"push">>, <<"p1:push">>} ->
	  decode_p1_push(<<"p1:push">>, IgnoreEls, _el);
      {<<"status">>, <<"p1:push">>} ->
	  decode_p1_push_status(<<"p1:push">>, IgnoreEls, _el);
      {<<"session">>, <<"p1:push">>} ->
	  decode_p1_push_session(<<"p1:push">>, IgnoreEls, _el);
      {<<"keepalive">>, <<"p1:push">>} ->
	  decode_p1_push_keepalive(<<"p1:push">>, IgnoreEls, _el);
      {<<"stream:features">>,
       <<"http://etherx.jabber.org/streams">>} ->
...
get_ns({stream_features, _}) ->
    <<"http://etherx.jabber.org/streams">>;
get_ns({p1_push_status, _, _}) -> <<"p1:push">>;
get_ns({p1_push, _, _, _}) -> <<"p1:push">>;
get_ns({p1_rebind_failure, _}) -> <<"p1:rebind">>;
get_ns({p1_rebind, _, _}) -> <<"p1:rebind">>;
get_ns({p1_standby, _}) -> <<"p1:rebind">>;
...
decode_p1_standby(__TopXMLNS, __IgnoreEls,
		  {xmlel, <<"standby">>, _attrs, _els}) ->
    Set = decode_p1_standby_els(__TopXMLNS, __IgnoreEls,
				_els, <<>>),
    {p1_standby, Set}.

decode_p1_standby_els(__TopXMLNS, __IgnoreEls, [],
		      Set) ->
    decode_p1_standby_cdata(__TopXMLNS, Set);
decode_p1_standby_els(__TopXMLNS, __IgnoreEls,
		      [{xmlcdata, _data} | _els], Set) ->
    decode_p1_standby_els(__TopXMLNS, __IgnoreEls, _els,
...
decode_p1_rebind(__TopXMLNS, __IgnoreEls,
    ...
    {Sid, Jid} = decode_p1_rebind_els(__TopXMLNS,
				      __IgnoreEls, _els, undefined, undefined),
    {p1_rebind, Jid, Sid}.

decode_p1_rebind_els(__TopXMLNS, __IgnoreEls, [], Sid,
		     Jid) ->
    {Sid, Jid};
decode_p1_rebind_els(__TopXMLNS, __IgnoreEls,
		     [{xmlel, <<"jid">>, _attrs, _} = _el | _els], Sid,
		     Jid) ->
    _xmlns = get_attr(<<"xmlns">>, _attrs),
    if _xmlns == <<>>; _xmlns == __TopXMLNS ->
	   decode_p1_rebind_els(__TopXMLNS, __IgnoreEls, _els, Sid,
				decode_p1_rebind_jid(__TopXMLNS, __IgnoreEls,
						     _el));
       true ->
	   decode_p1_rebind_els(__TopXMLNS, __IgnoreEls, _els, Sid,
				Jid)
...
decode_p1_rebind_els(__TopXMLNS, __IgnoreEls,
    ...
    _xmlns = get_attr(<<"xmlns">>, _attrs),
    if _xmlns == <<>>; _xmlns == __TopXMLNS ->
	   decode_p1_rebind_els(__TopXMLNS, __IgnoreEls, _els,
				decode_p1_rebind_sid(__TopXMLNS, __IgnoreEls,
						     _el),
				Jid);
       true ->
	   decode_p1_rebind_els(__TopXMLNS, __IgnoreEls, _els, Sid,
...
encode_p1_rebind({p1_rebind, Jid, Sid}, _xmlns_attrs) ->
    _els = lists:reverse('encode_p1_rebind_$sid'(Sid,
						 'encode_p1_rebind_$jid'(Jid,
									 []))),
    _attrs = _xmlns_attrs,
    {xmlel, <<"rebind">>, _attrs, _els}.
...
decode_p1_rebind_sid(__TopXMLNS, __IgnoreEls,
    ...
    Cdata = decode_p1_rebind_sid_els(__TopXMLNS,
				     __IgnoreEls, _els, <<>>),
    Cdata.

decode_p1_rebind_sid_els(__TopXMLNS, __IgnoreEls, [],
			 Cdata) ->
    decode_p1_rebind_sid_cdata(__TopXMLNS, Cdata);
decode_p1_rebind_sid_els(__TopXMLNS, __IgnoreEls,
			 [{xmlcdata, _data} | _els], Cdata) ->
    decode_p1_rebind_sid_els(__TopXMLNS, __IgnoreEls, _els,
			     <<Cdata/binary, _data/binary>>);
decode_p1_rebind_sid_els(__TopXMLNS, __IgnoreEls,
			 [_ | _els], Cdata) ->
    decode_p1_rebind_sid_els(__TopXMLNS, __IgnoreEls, _els,
...
decode_p1_rebind_jid(__TopXMLNS, __IgnoreEls,
		     {xmlel, <<"jid">>, _attrs, _els}) ->
    Cdata = decode_p1_rebind_jid_els(__TopXMLNS,
				     __IgnoreEls, _els, <<>>),
    Cdata.

decode_p1_rebind_jid_els(__TopXMLNS, __IgnoreEls, [],
			 Cdata) ->
    decode_p1_rebind_jid_cdata(__TopXMLNS, Cdata);
decode_p1_rebind_jid_els(__TopXMLNS, __IgnoreEls,
			 [{xmlcdata, _data} | _els], Cdata) ->
    decode_p1_rebind_jid_els(__TopXMLNS, __IgnoreEls, _els,
			     <<Cdata/binary, _data/binary>>);
decode_p1_rebind_jid_els(__TopXMLNS, __IgnoreEls,
			 [_ | _els], Cdata) ->
    decode_p1_rebind_jid_els(__TopXMLNS, __IgnoreEls, _els,
...
decode_p1_rebind_failure(__TopXMLNS, __IgnoreEls,
			 {xmlel, <<"failure">>, _attrs, _els}) ->
    Reason = decode_p1_rebind_failure_els(__TopXMLNS,
					  __IgnoreEls, _els, <<>>),
    {p1_rebind_failure, Reason}.

decode_p1_rebind_failure_els(__TopXMLNS, __IgnoreEls,
			     [], Reason) ->
    decode_p1_rebind_failure_cdata(__TopXMLNS, Reason);
decode_p1_rebind_failure_els(__TopXMLNS, __IgnoreEls,
			     [{xmlcdata, _data} | _els], Reason) ->
    decode_p1_rebind_failure_els(__TopXMLNS, __IgnoreEls,
				 _els, <<Reason/binary, _data/binary>>);
decode_p1_rebind_failure_els(__TopXMLNS, __IgnoreEls,
			     [_ | _els], Reason) ->
    decode_p1_rebind_failure_els(__TopXMLNS, __IgnoreEls,
				 _els, Reason).
...
decode_p1_push(__TopXMLNS, __IgnoreEls,
	...
	decode_p1_push_els(__TopXMLNS, __IgnoreEls, _els,
			   undefined, undefined, undefined),
    {p1_push, Keepalive, Session, Status}.

decode_p1_push_els(__TopXMLNS, __IgnoreEls, [], Status,
		   Keepalive, Session) ->
    {Status, Keepalive, Session};
decode_p1_push_els(__TopXMLNS, __IgnoreEls,
    ...
    if _xmlns == <<>>; _xmlns == __TopXMLNS ->
	   decode_p1_push_els(__TopXMLNS, __IgnoreEls, _els,
			      Status,
			      decode_p1_push_keepalive(__TopXMLNS, __IgnoreEls,
						       _el),
			      Session);
       true ->
	   decode_p1_push_els(__TopXMLNS, __IgnoreEls, _els,
...
decode_p1_push_els(__TopXMLNS, __IgnoreEls,
    ...
    if _xmlns == <<>>; _xmlns == __TopXMLNS ->
	   decode_p1_push_els(__TopXMLNS, __IgnoreEls, _els,
			      Status, Keepalive,
			      decode_p1_push_session(__TopXMLNS, __IgnoreEls,
						     _el));
       true ->
	   decode_p1_push_els(__TopXMLNS, __IgnoreEls, _els,
			      Status, Keepalive, Session)
...
decode_p1_push_els(__TopXMLNS, __IgnoreEls,
    ...
    if _xmlns == <<>>; _xmlns == __TopXMLNS ->
	   decode_p1_push_els(__TopXMLNS, __IgnoreEls, _els,
			      decode_p1_push_status(__TopXMLNS, __IgnoreEls,
						    _el),
			      Keepalive, Session);
       true ->
	   decode_p1_push_els(__TopXMLNS, __IgnoreEls, _els,
...
decode_p1_push_els(__TopXMLNS, __IgnoreEls, [_ | _els],
		   Status, Keepalive, Session) ->
    decode_p1_push_els(__TopXMLNS, __IgnoreEls, _els,
		       Status, Keepalive, Session).
...
encode_p1_push({p1_push, Keepalive, Session, Status},
	       _xmlns_attrs) ->
    _els = lists:reverse('encode_p1_push_$status'(Status,
						  'encode_p1_push_$keepalive'(Keepalive,
									      'encode_p1_push_$session'(Session,
													[])))),
    _attrs = _xmlns_attrs,
    {xmlel, <<"push">>, _attrs, _els}.
...
decode_p1_push_status(__TopXMLNS, __IgnoreEls,
		      {xmlel, <<"status">>, _attrs, _els}) ->
    Text = decode_p1_push_status_els(__TopXMLNS,
				     __IgnoreEls, _els, <<>>),
    Type = decode_p1_push_status_attrs(__TopXMLNS, _attrs,
				       undefined),
    {p1_push_status, Type, Text}.

decode_p1_push_status_els(__TopXMLNS, __IgnoreEls, [],
			  Text) ->
    decode_p1_push_status_cdata(__TopXMLNS, Text);
decode_p1_push_status_els(__TopXMLNS, __IgnoreEls,
			  [{xmlcdata, _data} | _els], Text) ->
    decode_p1_push_status_els(__TopXMLNS, __IgnoreEls, _els,
