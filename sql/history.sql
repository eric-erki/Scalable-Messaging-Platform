...
CREATE PROCEDURE log_msg(IN user_in TEXT , IN sender_in TEXT , IN collection_in TEXT , IN msg_id_in TEXT, IN message_in BLOB , IN at_in DATETIME, IN is_read_in BOOLEAN)
	BEGIN
