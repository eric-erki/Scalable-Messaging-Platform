...
-define(DEFAULT_MONITORS,
        [{c2s_receive, [message_receive_packet,chat_receive_packet,groupchat_receive_packet,
         ...
         {message_queues, process_queues, []},
         {iq_message_queues, worker_message_queues, ejabberd_iq_sup},
         {sm_message_queues, worker_message_queues, ejabberd_sm_sup},
         {c2s_message_queues, worker_message_queues, ejabberd_c2s_sup},
         {odbc_message_queues, worker_message_queues, ejabberd_odbc_sup},
         {offline_message_queues, worker_message_queues, mod_offline_pool},
         {iq_internal_queues, worker_internal_queues, ejabberd_iq_sup},
         {sm_internal_queues, worker_internal_queues, ejabberd_sm_sup},
         {c2s_internal_queues, worker_internal_queues, ejabberd_c2s_sup},
         {odbc_internal_queues, worker_internal_queues, ejabberd_odbc_sup},
         {offline_internal_queues, worker_internal_queues, mod_offline_pool},
